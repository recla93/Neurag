...
`neurag gui` su una macchina SENZA rete. È un artefatto congelato al momento
della release di NeuRAG, e il pyproject stesso lo dice ("va ricostruito a ogni
...
ROOT = Path(__file__).resolve().parents[1]           # .../neurag
VENDOR = ROOT / "_gm_vendor"
MAIN = ROOT / "cli.py"
