...
accendere il bridge (`neurag.bridge`, Streamable HTTP su :8001), esporlo
...
# Copia keep-in-sync con gray_matter/chatgpt.py e neuron/src/neuron/chatgpt.py: anche
...
TOOL_LABEL = "NeuRAG"
BRIDGE_MODULE = "neurag.bridge"
BRIDGE_PORT = 8001                    # Neuron=8000, NeuRAG=8001, suite intera=8002
